...
const Navbar = () => {
  ...
  return (
    <>
    <header className='sticky top-0 flex justify-center items-center p-4 w-full'>
...
{!show ? <button className='md:hidden block bg-primary rounded-full p-1.5 z-50'>
          <FiMenu
            size={25}
            color='white'
...
{show &&
<>
<div className="fixed bg-gray-900 top-0 left-0 w-full h-screen opacity-35"></div>
<div className={`fixed right-0 top-0 ${show ? "swipeToLeft" : "swipeToRight"} w-3/4 h-screen bg-gray-900 p-3`}>
      ...
      <div className="overflow-y-scroll h-full">
        <ul className="text-white text-center mt-12 gap-8 text-3xl flex justify-center flex-col items-center font-semibold">
          <li className="hover:text-primary transition-all ease-in-out cursor-pointer duration-500">Home</li>
          <li className="hover:text-primary transition-all ease-in-out cursor-pointer duration-500">Service</li>
          <li className="hover:text-primary transition-all ease-in-out cursor-pointer duration-500">About</li>
          <li className="hover:text-primary transition-all ease-in-out cursor-pointer duration-500">Projects</li>
          <li className="hover:text-primary transition-all ease-in-out cursor-pointer duration-500">Contact</li>
        </ul>
